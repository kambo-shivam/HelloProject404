package com.appventurez.project404.services;
...
import com.appventurez.project404.utility.MarshMallowPermission;
    ...
    public Location getLocation() {
        try {
            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
                ...
                if (MarshMallowPermission.checkPermission(mContext)) {
